...
export function ThemeToogle() {
    ...
    return (
        ...
        <Button variant="outline" size="icon" className="rounded-full mt-4 absolute top-4 right-4 z-20 transition-all duration-300" onClick={() => setTheme(theme === "light" ? "dark" : "light")}>
