...
export function ThemeToogle() {
    ...
    return (
        <Button title="theme change" variant="outline" size="icon" className="rounded-full mt-4 fixed top-4 right-4 z-20 transition-all duration-300 cursor-pointer" onClick={() => setTheme(theme === "light" ? "dark" : "light")}>
